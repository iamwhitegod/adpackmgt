...
var navbarList = document.querySelector(".navbar__bottom-list");
var form = document.querySelector("#js--form");
var fullname = document.querySelector("#fullname");
var email = document.querySelector("#email");
var subject = document.querySelector("#subject");
var message = document.querySelector("#message");
console.log(form, fullname, email, subject, message); // Open mobile navigation

navbar.addEventListener("click", function (e) {
  var navbarOpen = e.target.closest(".navbar__open");
...
navbar.addEventListener("click", function (e) {
  var navbarOpen = e.target.closest(".navbar__close");
...
form.addEventListener("submit", function (e) {
  ...
  var res = _axios.default.post("https://adpackmgt.herokuapp.com/request", userData); // sendEmail();
